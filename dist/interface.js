...
exports.menu = exports.bankMenuKeyboard = exports.calculateOperations = exports.bankOperations = void 0;
...
exports.calculateOperations = [
    [
        { text: "💰 Сума покупкі", callback_data: "sum_buy" },
        { text: "💹 Курс покупкі", callback_data: "course_buy" },
    ],
    [
